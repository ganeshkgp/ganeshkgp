...
/**
 * Returns a getter function for settings with fallback to defaults.
 * Usage inside <script setup>: const s = useSetting(props)
 */
export function useSetting(props) {
    return (key) => props.settings?.[key] ?? defaultSettings[key];
}
